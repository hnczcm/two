...
* @Last Modified by:   hp
* @Last Modified time: 2019-08-16 10:15:34
*/
...
$(function(){
	...
	$('.clearFixLeft>ul>li').eq(0).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(1).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部s
	...
	$('.clearFixLeft>ul>li').eq(2).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(3).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(4).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(5).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(6).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(7).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(8).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(9).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	$('.clearFixLeft>ul>li').eq(10).click(function(event) {
			// 事件源：body,html
			// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
			$('body,html').animate({
				// 带有动画回到顶部
	...
	// $('.clearFixLeft>ul>li').eq(11).click(function(event) {
	// 		// 事件源：body,html
	// 		// scrollTop滚动条距离页面顶部的距离，scrollTop在css中没有，是animate中特有的
	// 		$('body,html').animate({
	// 			// 带有动画回到顶部
